...
const file_snapshot_proto_rawDesc = "" +
	"\n" +
	"\x0esnapshot.proto\x12\vsnapshot.v1\"\x18\n" +
	"\x16TriggerSnapshotRequest\"W\n" +
	"\x17TriggerSnapshotResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03key\x12\x12\n" +
	"\x04hash\x18\x03 \x01(\tR\x04hash\"\x16\n" +
	...
	"\rListSnapshots\x12!.snapshot.v1.ListSnapshotsRequest\x1a\".snapshot.v1.ListSnapshotsResponse\"\x00BCZAgithub.com/fairtier/snapshot-sidecar/proto/snapshot/v1;snapshotv1b\x06proto3"
